...
export const BASIC_HOMEWORK = [
  ...
  /**
   * 저절로리딩 브릿지 라인의 1회성 선행 과제 (원장님, 2026-08-13).
   * 루틴은 순환(% len)이라 루틴 줄에 넣지 않고, 교재 시작할 때 손으로 낸다.
   */
  {
    name: "품사 쇼츠 강의 + 빈칸 채우기",
    category: "독해",
    kind: "home",
    method:
      "쇼츠 강의를 듣고 빈칸 문제를 모두 채웁니다.\n" +
      "· 교재(브릿지)를 시작할 때 한 번만 나가는 숙제입니다",
  },
  {
    name: "3단변화 문제 + 발음 녹음 3회",
    category: "독해",
    kind: "home",
    method:
      "3단변화 문제를 풀고, 동사-과거-과거분사 발음을 3번 녹음해 카톡으로 인증합니다.\n" +
      "· 걸린 시간도 재서 씁니다\n" +
      "· 브릿지2 를 시작할 때 한 번만 나가는 숙제입니다",
  },
  {
    name: "직독직해 · 스피킹",
    category: "독해",
  ...
  // ---------------- 문법 ----------------
  /**
   * 원장님 확정 사이클 (2026-08-13):
   *   정독+형광펜 → 교재로 문답노트 → 강의듣고 문답노트 → 구두테스트(등원)
   *   ↔ 셀프녹음(집) → 클래스카드 문법훈련 → 본교재 → 실전 모의고사 →
   *   워크북 → 채고세별
   * 「정독」과 「문답노트」는 따로 하시므로 항목도 가른다 (합쳐져 있던
   * 「문법 개념 정독 · 문답노트 정리」 는 목록에서 뺐다 — DB 에 이미 있는
   * 학원은 그대로 남으니 원장님이 정리하시면 된다).
   */
  {
    name: "문법 개념 정독 + 형광펜",
    category: "문법",
    kind: "home",
    method: "설명을 꼼꼼히 읽고 중요한 곳에 형광펜 표시합니다.",
  },
  {
    name: "문법 문답노트 작성 (교재)",
    category: "문법",
    kind: "home",
    method: "교재 설명을 보며 개념노트에 **문답노트 형식**으로 요약 정리합니다.",
  },
  {
    name: "문법 강의 듣고 정리",
    category: "문법",
  ...
  },
  {
    ...
    category: "영작",
    kind: "home",
    method: "채고세별에서 세모 · 별표한 문제를 다시 풉니다.",
  },
  {
    name: "영작 워크북 풀기",
    category: "영작",
  ...
  // ---------------- 노트 ----------------
  /**
   * 「채고세별」 은 학원 공통 마무리 규칙이다 (원장님이 문법·영작 루틴
   * 양쪽에 쓰심, 2026-08-13). 문제를 푸는 모든 영역에서 같이 쓴다.
   */
  {
    name: "채고세별",
    category: "노트",
