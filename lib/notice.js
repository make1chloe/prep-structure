/** 📢 공지의 손(4단계-6) · 판 읽기(notice_board) · 만들기·고치기(보내기 전만) · 📎 붙이기(보내기 전만 · 보낸 뒤에 붙이면 먼저 본 집은 못 본다, 목업 20) · 보내기(받는 쪽·반·학교로 대상 아이를 고르고 아이마다 notify 유형 notice · 발송 이력은 notify_log · 끝에 sent_at) · 읽음 찍기(정의자 함수)
