...
export const PAGES = [
  {
    ...
    blocks: [
      { key: "month", label: "이번 달 현황", desc: "출결 · 숙제 · 단어 · 문법" },
      { key: "schedule", label: "일정 및 전달사항", desc: "다가오는 일정 · 학원 공지" },
      { key: "study", label: "하원 숙제 · 등원 학습", desc: "등원 체크 · 타이머 · 전체 목록" },
      { key: "last", label: "지난 수업", desc: "단어 · 문장 점수 · 진도" },
      { key: "checked", label: "지난 숙제 검사", desc: "○ △ ✕ 결과" },
      { key: "stay", label: "남아서 하고 갈 것", desc: "늦귀가 과제" },
      { key: "videos", label: "볼 영상" },
      { key: "myscore", label: "시험 결과 적기", desc: "모의고사 · 내신 오답 (아이가 직접)" },
      { key: "help", label: "선생님 도움 · 쉬는 시간", desc: "지금 상태 · 보내는 글 · 질문" },
      { key: "guide", label: "수업 가이드", desc: "설정에 넣은 링크" },
      { key: "calendar", label: "달력", desc: "수업일 · 시험 · 결석" },
    ],
  },
  {
    key: "parent",
    ...
    blocks: [
      { key: "today", label: "오늘", desc: "다음 수업 · 오늘 출결 · 늦은 하원" },
      { key: "month", label: "이번 달 현황", desc: "출결 · 숙제 · 단어 · 문법" },
      { key: "schedule", label: "일정 및 전달사항", desc: "다가오는 일정 · 학원 공지" },
      { key: "homework", label: "지금 나간 숙제", desc: "아이 화면과 같은 목록" },
      { key: "lessons", label: "최근 수업", desc: "출결 · 점수 · 진도 · 숙제 검사" },
      { key: "scores", label: "성적", desc: "내신 · 모의고사 · 단원평가" },
      { key: "monthly", label: "월간리포트" },
      { key: "calendar", label: "달력", desc: "수업일 · 시험 · 결석" },
      { key: "request", label: "보내기", desc: "결석 · 보강 신청" },
      { key: "comments", label: "남기실 말씀", desc: "최근 수업에 대한 문의" },
    ],
  },
];
