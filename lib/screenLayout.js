...
export const NAV_GROUPS = {
  me: [
    { key: "todo", nav: "할 것", blocks: ["study", "stay", "videos", "myscore"] },
    { key: "news", nav: "알림", blocks: ["schedule"] },
    { key: "record", nav: "내 기록", blocks: ["month", "last", "checked"] },
    { key: "cal", nav: "달력", blocks: ["calendar"] },
    { key: "teacher", nav: "선생님께", blocks: ["help", "guide"] },
  ],
  parent: [
    { key: "today", nav: "오늘", blocks: ["today"] },
    { key: "class", nav: "숙제·수업", blocks: ["homework", "lessons"] },
    { key: "news", nav: "알림", blocks: ["schedule"] },
    { key: "record", nav: "기록", blocks: ["month", "scores", "monthly"] },
    { key: "cal", nav: "달력", blocks: ["calendar"] },
