...
export const PAGES = [
  {
     ...
     * 메뉴가 업로드 → 공지 → 일정 → 학습 → 성장인데 화면 덩어리가 다른
     * 차례로 쌓여 있으면, 메뉴를 눌러 내려간 자리와 눈의 기대가 어긋난다.
...
export const NAV_GROUPS = {
  ...
  me: [
    { key: "upload", nav: "업로드", blocks: ["help", "guide"] },
    { key: "news", nav: "공지", blocks: ["schedule"] },
    { key: "cal", nav: "일정", blocks: ["calendar"] },
    { key: "todo", nav: "학습", blocks: ["study", "stay", "videos", "myscore"] },
    { key: "record", nav: "성장", blocks: ["month", "last", "checked"] },
  ],
  parent: [
