...
/** 「지금 멈춤」이 안 건드린 까닭 — 한 벌(lib/exam.js 가 세고, 화면이 이 말로 읽는다) */
export const SKIP_WHY = Object.freeze({ other: "다른 시험에 묶임", area: "내신 교재", rule: "규칙 줄 없음", hand: "손으로 멈춤", freed: "손으로 풀어 둠", none: "보는 아이 없음" });
const SKIP_TIP = Object.freeze({ [SKIP_WHY.other]: "그 회차에서 「풀기」를 먼저", [SKIP_WHY.rule]: "설정 → 교재 멈춤에서 주 수를 정하십시오", [SKIP_WHY.none]: "「안 봄」을 풀거나 아이의 학교·학년을 보십시오" });
/** 「지금 멈춤」의 끝말 — 0권이면 **까닭까지** 말한다(대전제-0. 2026-09-12 내신대비 한 판에서 「교재 0권」만 뜨고 까닭이 없어 막혔다) */
...
/** 「풀기」의 끝말 — 0권이면 까닭부터(검사-86 · 「지금 멈춤」과 짝이다) */
