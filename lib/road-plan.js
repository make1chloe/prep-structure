...
export function editBand(edit = {}, student = {}) {
  if (edit.can_edit) return { open: true, title: "진도 체크가 열려 있어요", small: "소단원마다 ○ ◐ ·", pill: "열림" };
  if (student.progress_edit === "off") return { open: false, title: "진도 체크가 닫혀 있어요", small: "내 것만 닫혀 있어요 · 잘못된 것은 ❗", pill: "닫힘" };
  return { open: false, title: "진도 체크가 닫혀 있어요", small: "지금은 보기만", pill: "닫힘" };
}
