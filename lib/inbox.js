 ...
 *
 * **할 일은 안 센다.** 보강 필요 · 안 보낸 리포트 · 반성문 대상은
...
// 동시 호출 합치기 (성능수리 v3 §2-3-1) — 메모가 식은 순간 두 곳이 같이
// 부르면 같은 셈이 두 벌 나간다. 규칙은 menuBadges 와 같다: production
// 게이트 · 실패 promise 비캐시. (이 셈은 날짜와 무관이라 day 키는 없다)
let _inflight = null;
