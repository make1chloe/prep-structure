...
export const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/plan", key: "plan", label: "수업 준비", desc: "미리 정해두기 · 지난 수업" },
    ],
  },
  {
  ...
  },
  {
    ...
    label: "설정",
    href: "/menu/settings",
    keys: ["settings", "messages", "screen", "guide", "sql", "import"],
    items: [
      ...
      // 화면에 뜨는 안내를 원장님이 직접 적으신다 (0093).
      // 「특히 학생학부모용」 — 알림톡을 끊었으니 그 화면이 학원의 말이 닿는 자리다
      //
      // key 가 「notes」 였는데 상담일지(/notes)와 겹쳐서, 상담일지를 열면
      // 이쪽도 같이 켜진 것처럼 보였다 (2026-08-07)
      { href: "/settings/notes", key: "guide", label: "안내 문구", desc: "학생 · 학부모 화면" },
