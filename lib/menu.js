...
export const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { href: "/textbooks", key: "textbooks", label: "교재", desc: "교재 · 단원" },
      { href: "/homework", key: "homework", label: "학습항목", desc: "정독 · 문제풀기 · 구두테스트 같은 「하는 것」" },
  ...
  },
  {
    ...
    items: [
       ...
       * 없는 것의 까닭을 가릴 수가 없다.
       */
      { href: "/neis", key: "neis", label: "나이스", desc: "학교가 올린 그대로" },
    ],
  },
  {
    /**
