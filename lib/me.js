...
export async function meDay(sb, user, date) {
  ...
  const [people, arrival, sheetR, lastR, quizzes, abs, late, books, todo, memos, days, access, gives, asks, scoresR, examsR, linksR, rules, assignsR, progressR] = await Promise.all([
