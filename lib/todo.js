...
export const addNote = (sb, { title, kind = null, dueOn = null, dueTime = null, studentId = null, note = null, startOn = null }) => addTodo(sb, { title, kind, dueOn, dueTime, studentId, note, startOn });   // (어88) 종류를 고르면 그 칸으로 선다   // (어78) 마감·시작일은 없어도 된다 — 퀵 메모가 같은 손을 쓴다(원칙-1)
