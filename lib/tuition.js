import { DOW as DAYS } from "./day.js";
// 회차 기준 수강료 계산
 ...
 * @param unit      월 수강료
 * @param student   { enrolled_on, ended_on }
 */
/**
 * 학생 한 명의 그 달 금액
 *
...
export function studentAmount(
  ...
  // 시작일은 enrolled_on 하나 (0127 — A18 합침). started_on 은 0127 을
  // 아직 안 돌린 DB 를 위한 폴백이다
  const from = student.enrolled_on || student.started_on || null;
