...
import { parseCuts, parseQuestions, parseWrong, SHOW, rowsOf } from "./score-plan.js";
...
export async function saveScore(sb, { examId, studentId, raw, full = 100, wrongs = "", note = null, byWho = "staff", showTo = null }, date) {
  ...
  const patch = { raw: n, full_score: f, taken_on: e.english_on ?? e.term_from ?? date, note: note ?? null };
  let id = ex?.id ?? null;
