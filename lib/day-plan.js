...
/** 단원 나무((어32)) · itemOrder 로 세운 줄을 교재·대단원 → 단원 → 활동으로 자른다 · [{ key, book, chapter, units: [{ id, unit, rows }] }] · 단원 없는 줄은 맨 끝 한 묶음(book · chapter · unit 이 null). 쪽·문항은 단원마다(unitBits 로 그린다) */
