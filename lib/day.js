...
const SHEET_SEL = "*,day_item(*,units(id,book_id,chapter,page_start,page_end,q_count,label,short),learn_items(name),carry:carry_of(day_sheet(date))),late_stay(*),sheet_book(*),day_area_memo(*)";
