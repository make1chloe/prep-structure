...
export async function roster(sb, date, people = null) {
  ...
  const [{ data: sheets, error }, books, quizzes, warns, units, stays, soon] = await Promise.all([
