...
export const SEVEN = Object.freeze([["student", "학생 등록", "이름·학년·학교·연락처가 상담에서 그대로"], ["accounts", "계정 발급", "학생·학부모 둘 다 · 첫 비밀번호 0000"], ["class", "반 배정", "요일·시각을 고르면 회차가 그날부터"], ["books", "교재 배정", "레벨 결과에서 제안 · 기준·회차는 루틴 11 에서"], ["routine", "루틴", "영역 루틴이 저절로 · 짤 것이 없습니다"], ["fee", "결제선생 등록", "업무에 카드로 섭니다"], ["welcome", "첫 등원 안내", "준비물·시간표 · 학부모 계정으로(문자는 아직)"]]);
