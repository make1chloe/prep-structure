 ...
 */
/**
 * **쉬는 날은 시험이 아니다** (2026-08-09). 「대수능시험 휴업일」 은 이름에
 * 「시험」 이 들어 있어서 내신 시험 기간으로 잡혔고, 그 학교 아이들이
 * 그날 시험을 보는 것으로 계산됐다. 휴업·휴일·방학이 붙으면 시험이 아니다.
 */
const NOT_EXAM = /(수행|학업성취|성취도|진단|기초학력|졸업|자격|경시|인증|검정|휴업|휴일|방학|휴교)/;
