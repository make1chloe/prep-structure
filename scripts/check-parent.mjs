...
ok("보낸 것 · 오늘 것은 빼고 최근 것부터 「9/3 하원 지연 안내 · 21:40 예정 · 21:52 하원」", sentLines(fam, today).map((s) => s.text).join(" | ") === "9/3 하원 지연 안내 · 21:40 예정 · 21:52 하원");
...
console.log("■ 💰 이 달 수강료 · 📨 내게 온 발송 이력(4단계-2a)");
...
ok("실제로 나간 것만(sent_at) · 「9/6 데일리리포트 · 읽음 13:05」 · 「9/7 수강료 안내 · 안 읽음」 · url 없으면 /parent · 발송 이력만 남은 것(리허설)은 빠진다", nl.length === 2 && nl[0].text === "9/6 데일리리포트" && nl[0].small === "읽음 13:05" && nl[1].text === "9/7 수강료 안내" && nl[1].small === "안 읽음" && nl[1].url === "/parent#fee" && noticeLines().length === 0, JSON.stringify(nl));
