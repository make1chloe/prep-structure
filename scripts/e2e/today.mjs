...
await su.locator("[data-g=student-row][data-student='99999999-0000-4000-9000-000000000001']").click(); await p.waitForURL((u) => u.searchParams.get("s") === "99999999-0000-4000-9000-000000000001", { timeout: 15000 }); await p.waitForLoadState("networkidle").catch(() => {});   // 이름이 같은 줄이 둘(학생둘 · 이관 리허설) — 줄은 id 로 · router.push 라 주소가 바뀔 때까지((나)-② — 전엔 대기가 주석 뒤에 있어 안 돌았다)
