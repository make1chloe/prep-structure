...
ok("(어76) 아이 검사 부호도 한 벌에서 온다 · 검사 끝난 줄은 ⭕🔺❌ 로만 말한다(글자 ○△✕ 0)", !(await meMain.locator("[data-card=due]").textContent()).includes("검사 ○") && !(await meMain.locator("[data-card=due]").textContent()).includes("검사 △"));
