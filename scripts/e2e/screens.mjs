...
await p.setViewportSize(VIEWS[0].viewport);
await p.setViewportSize(VIEWS[0].viewport);
console.log("■ 루틴 11 · 학원 기본 루틴(영역 일곱) · + 항목 · ✎ · ▲▼ · 🗑 내림·복구 · 예습 · 아이만 수정 · 교재 기준·회차·이대로면");
