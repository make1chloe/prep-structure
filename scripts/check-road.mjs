...
ok("띠 · 열림 · 닫힘(학원) · 닫힘(이 아이만) · 갈래 셋 · 모드 셋", editBand({ can_edit: true }).open === true && editBand({ can_edit: false }, { progress_edit: "follow" }).small.includes("지금은 보기만") && editBand({ can_edit: false }, { progress_edit: "off" }).small.includes("내 것만") && FLAG_KIND.length === 3 && EDIT_MODE.length === 3);
