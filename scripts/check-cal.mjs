/** 달력 검사(검사-㊻ · 목업 09b) · 순수 판단 lib/cal-plan.js: 달 범위(월요일부터 42칸) · 날마다 표시의 우선(휴강 › 결석(보강) › 지각·하원 지연 › 정시 › 보강 › 앞날 수업 예정 + 숙제·시험) · 날 하나의 줄들(출·수·숙·시·휴) · 달 글 */
...
ok("지각 판 + 숙제 → ⏰📘 · 정시 판 + 숙제 → ✓📘 · 하원 지연(예상 귀가 있음)면 정시여도 ⏰", M("2026-09-10", { days, sheet: { attend: "late", home_count: 2 } }) === "⏰📘" && M("2026-09-03", { sheet: { attend: "present", home_count: 1 } }) === "✓📘" && M("2026-09-03", { sheet: { attend: "present", home_count: 0, late: { until_at: "22:20:00" } } }) === "⏰");
...
ok("시험 본 날 📝 · 학교 시험일 📝(영어 시험일 없으면 기간 시작) · 물린 결석은 안 뜬다", M("2026-09-10", { quizzes: [{ taken_on: "2026-09-10" }] }) === "📝" && isExamDay("2026-09-19", [{ english_on: "2026-09-19" }]) && isExamDay("2026-09-21", [{ english_on: null, term_from: "2026-09-21" }]) && M("2026-09-08", { absences: [{ of_date: "2026-09-08", state: "cancelled" }] }) === "");
console.log("■ 날 하나의 줄");
