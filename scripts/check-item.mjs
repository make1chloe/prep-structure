...
{ const d1 = { student_id: "s", date: "2026-09-13" }, d2 = { student_id: "s", date: "2026-09-14" };
  ...
  ok("나무: [문법 ㄱ책: PART 2(❷·❸)] [독해 ㄴ책: UNIT 1(1-1)] [기타] · 영역·교재 마디 위에 unitTree 그대로", JSON.stringify(f.map((b) => [b.area, b.book, b.chapters.map((ch) => [ch.chapter, ch.units.map((g) => g.unit?.short ?? null)])])) === JSON.stringify([["문법", "ㄱ책", [["PART 2", ["STEP 2 ❷", "STEP 2 ❸"]]]], ["독해", "ㄴ책", [["UNIT 1", ["1-1"]]]], [null, null, [[null, [null]]]]]), JSON.stringify(f.map((b) => [b.area, b.book])));
