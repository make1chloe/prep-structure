  ...
  where col.table_schema='v2'
    and (col.column_name in ('name','phone','comment','body','said','note','reason','staff_note','orig_name','title')
         and col.table_name not in ('purge_map','import_check','area_map','import_skip','books','units','learn_items','material_type','grammar_topics',
             'schools','video','msg_template','auto_rule','rule','notice','todo','material','file_bin','exams','classes','file','placeholder','school_book','todo_kind'))   -- rule: 임계값 설명(0100), 사람 이야기가 아니다 · file: 원장님 9/3 「그냥 둬. 지우지 마」(9/5 ㉒ 파기 목록을 만들지 않는다. 0128 이 뺐다) · placeholder: 치환 낱말 설명(뼈대-8 · 0131) · school_book: 학교 교과서 메모(처음-8 · 0131) · todo_kind: 업무 분류 이름((어80) · 0179 · 「📄 자료 만들기」 같은 칸 이름) · 셋 다 사람 이야기가 아니다
