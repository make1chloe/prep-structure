...
ok("(서) 「[이 아이 · M/D] …」 본보기가 있으면 지시문에 「이 아이에게 지난번에 보낸 글 — 호칭·톤만 잇는다」 · 없으면 그 줄 없음", promptFor({ kind: "normal", cap: 100, samples: ["[이 아이 · 9/1] 오늘도 잘했어요"], factLines: f }).system.includes("지난번에 보낸 글") && !promptFor({ kind: "normal", cap: 100, samples: ["[보통] 잘했어요"], factLines: f }).system.includes("지난번에 보낸 글"));
