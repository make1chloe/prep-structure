...
ok("gradeKey · 옛 설정 tuition.byGrade 의 키 「중2」 「고1」 · 학년 없으면 null", gradeKey("middle", 2) === "중2" && gradeKey("high", 1) === "고1" && gradeKey("elem", 6) === "초6" && gradeKey("middle", null) === null);
...
ok("학년 키 12 · 초1 … 고3 · 옛 설정 tuition.byGrade 의 키와 같은 글(gradeKey 가 만드는 것)", GRADE_KEYS.length === 12 && GRADE_KEYS[0] === "초1" && GRADE_KEYS[11] === "고3" && GRADE_KEYS.includes(gradeKey("middle", 2)) && GRADE_KEYS.includes(gradeKey("elem", 6)));
