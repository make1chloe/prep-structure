...
{ const row = readFileSync("app/today/row.js", "utf8"), board = readFileSync("app/today/board.js", "utf8");   // (어28)-② 01 학생 줄(.row[data-student] · 갈래 수에는 안 든다) · 원장님 「ㅇㅇ넣음」
...
{ const has = (p, re) => re.test(readFileSync(p, "utf8"));   // (어28)-③ 줄 갈래(-row)가 아닌 목록 넷 · 시험 카드 · 할 일 카드 · 묶음 안 파일 · 영상 카드
