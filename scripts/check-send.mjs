...
ok("제목 · [클로이영어] 수업 안내 · 이미 붙어 있으면 다시 안 붙인다 · 유형 열다섯(첫 등원 안내는 3단계-8 등록 전환 · 영상 안내는 3단계-9 알림)", titleFor("daily", "클로이영어") === "[클로이영어] 수업 안내" && titleFor("late", "클로이영어") === "[클로이영어] 하원 지연 안내" && titleFor("welcome", "클로이영어") === "[클로이영어] 첫 등원 안내" && titleFor("video", "클로이영어") === "[클로이영어] 영상 안내" && Object.keys(LABEL).length === 15);
ok("유형 열다섯 · + score 「성적 입력 안내」(16 알림 · 아이 기기도) · fee 「수강료 안내」(13 안내) · 4단계-2a · schedule 「수업 일정 안내」(12 확정 → 학부모 · 4단계-3b ㉚) · guide 「상담 안내」((커) 18 안내 문자 · 솔라피) · 제약(0154)과 같은 열", Object.keys(LABEL).length === 15 && titleFor("guide", "클로이영어") === "[클로이영어] 상담 안내" && titleFor("schedule", "클로이영어") === "[클로이영어] 수업 일정 안내" && titleFor("score", "클로이영어") === "[클로이영어] 성적 입력 안내" && titleFor("fee", "클로이영어") === "[클로이영어] 수강료 안내" && titleFor("reject", "클로이영어") === "[클로이영어] 숙제 다시 내기 안내");   // (어76) reject — 반려하면 아이에게
