...
export default function AddHomeworkForm() {
  ...
  return (
    <div className="card card-tight" style={{ marginTop: 10, width: "100%" }}>
      ...
      <form action={addHomeworkItem} className="row" style={{ gap: 8, marginTop: 10, alignItems: "flex-end" }}>
        ...
        <button className="btn btn-primary btn-sm" type="submit" style={{ marginBottom: 1 }}>추가</button>
      </form>
    </div>
  );
}
