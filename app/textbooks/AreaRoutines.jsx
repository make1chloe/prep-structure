...
/**
 * 영역 진도루틴 편집 (원장님, 2026-08-21 — 「루틴을 엑셀로 넣기만 하지 말고
 * 수정·삭제 가능하게 해줘」).
 *
 * 교재만의 진도루틴이 없는 교재는 영역(문법·영작…) 공통 루틴을 따르는데(0137),
 * 그 영역 진도루틴을 고칠 자리가 여태 없었다 — 교재 쪽 편집기에서는 「따르는 중」
  ...
  return (
    <div className="card card-tight" style={{ marginTop: 10, width: "100%" }}>
      <div className="row" style={{ justifyContent: "space-between", alignItems: "center" }}>
        <h2 style={{ margin: 0, fontSize: 15, fontWeight: 800 }}>영역 진도루틴</h2>
      ...
      <p className="hint" style={{ margin: "8px 0 10px", lineHeight: 1.7 }}>
        교재만의 진도루틴이 없는 교재는 여기 있는 <b>영역 공통 진도루틴</b>을 따릅니다.
