...
export default function Board({ d }) {
  ...
  const [cf2, setCf2] = useState({ idx: "", login: "" });   /* (녀) 🃏 클래스카드 아이디 잇기 칸 */
