...
import { todayPrep } from "@/lib/todo";
...
import Board, { ClassHead } from "./board.js";
  ...
  return frame(<>
    ...
    {other && <p className="note" data-g="other-day" style={{ margin: "0 0 8px" }}>
      <b>{future ? "앞으로 올 날" : "지난 날"}을 보고 있습니다</b> · {future
        ...
        : "고칠 수 있습니다. 이미 마감한 수업 일지는 읽기만 됩니다(마감이 곧 부모님께 나간 글입니다)."}
      {" "}수업 일지가 없는 아이는 <b>출결을 누르면</b> 그 날 수업 일지가 생깁니다. 저절로는 안 섭니다.</p>}
    <Band band={band} />
