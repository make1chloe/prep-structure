    ...
    <main className="wrap" style={{ maxWidth: 620, paddingBottom: 40 }}>
      ...
      <div className="card" style={{ marginTop: 14 }}>
        ...
        {/**
          ...
          * 「from 은 학생·학부모가 제출하면 원장 어플에 떠야지, 그게 왜
          *  학생·학부모한테 떠」).
          *
          * 아이폰은 알림에 **그 알림을 받은 앱의 이름**을 붙인다. 앱 이름이
          * 「학부모」 였을 때는 「전달사항 from 학부모」 로 읽혀서, 어머니가
          * 보내신 것처럼 보였다. 이름에 「…용」 을 붙여 오해를 줄였지만,
          * 한 줄로 적어두는 편이 확실하다.
          */}
        <p className="hint" style={{ margin: "8px 0 0" }}>
          <b>알림에 뜨는 「from …」</b> — 아이폰이 붙이는 말이고,
          <b> 그 알림을 받은 앱 이름</b>입니다. 보낸 사람이 아니에요.
          「from 클로이 학부모용」 은 <b>학부모용 앱이 받았다</b>는 뜻입니다.
          <br />
