...
import { addGrid, retireGrid, reviveGrid, renameGrid, addCol, setCol, moveCol, retireCol, setBoardCol, addRow, moveRow, retireRow, setCell, setWatch } from "@/lib/grid";
...
export async function colSetAct(colId, f) { return wrap(async () => { const { sb } = await staff(); await setCol(sb, colId, f); return {}; }); }
