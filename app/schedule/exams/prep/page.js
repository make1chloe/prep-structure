/** 📄 내신 자료 04(보드 A) — 시험을 고르면: 자료 나무(출처 › 갈래 › 항목) · 학생별(학교 진도 · 오늘 낼 것 · 남은 것) · ♻️ 같은 범위로 지난번에 만든 것(있다는 표시만 · 체크된 채로 선다, 확정-㊵) · 여기서 생긴 할 일. 판단은 lib/todo-plan(순수) · 손은 lib/todo.
...
export default async function Prep({ searchParams }) {
  ...
  catch (e) { { console.error("[화면] 내신 자료 못 엶:", e); return frame(<Oops what="내신 자료" e={e} />); } }
