/** 🛤️ 내 진도체크 08(보드 C) — 끝냄 · 하는 중 · 아직 세 칸(진도 나무는 표 하나 · 보기 넷, 확정-51) · 진도 체크가 열리면 소단원마다 내가 찍는다(확인 기다리는 중 · 원장님 줄은 못 덮는다, 확정-㊶) · ❗ 이의(진도는 안 바뀐다).
...
export default async function Road({ searchParams }) {
  ...
  } catch (e) { { console.error("[화면] 진도체크 못 엶:", e); return frame(<Oops what="진도체크" e={e} kind="task" />); } }
